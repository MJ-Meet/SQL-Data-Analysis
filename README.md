# <p align="center">DecodeLabs Internship Project: Netflix Shows and Movies Analysis</p>
# <p align="center">![Pic](https://i.ibb.co/Q81WwRN/92399716.jpg)</p>

**Tools Used:** Excel, MySQL, Tableau

This report documents my DecodeLabs internship project, where I analyzed Netflix content data to produce actionable insights using SQL and Tableau.
...
- **Business Problem:** Netflix needs to turn a large shows-and-movies dataset (about 82k rows) into useful insights for subscribers. The challenge is filtering and summarizing the data effectively so the team can identify trends, top-performing titles, and content gaps.

- **Approach:** I used SQL to extract key metrics, compare ratings, analyze genre distributions, and study release year patterns. Then I built Tableau visualizations to present the results clearly, enabling interactive exploration of genres, ratings, decades, and age certifications.
...
## Conclusion 
This DecodeLabs internship project provides a clear summary of Netflix content performance, highlighting which titles are strongest and weakest based on IMDB score, how content is distributed by release decade, and how age certifications relate to average ratings. The analysis also identifies the most common genres on Netflix, with comedy leading the pack followed by documentation and drama.

The SQL queries and Tableau dashboard together offer a practical way to explore audience trends, genre popularity, and rating patterns in a large dataset. These insights can help guide content decisions, improve recommendations, and support Netflix stakeholders in understanding their catalog more effectively.
